...
<table class="table table-striped">
	...
	<div class="row">
		  	...
		  	<div class="col-md-6 juridica">
				<div class="form-group">				
					<p><strong>A Tendas Fáceis</strong> Criada em 1982, a tenda fáceis surgiu para facilitar sua vida, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. <em>Aenean ultricies mi vitae est.</em> Mauris placerat eleifend leo. Quisque sit amet est et sapien ullamcorper pharetra. Vestibulum erat wisi, condimentum sed, <code>commodo vitae</code>, ornare sit amet, wisi. Aenean fermentum, elit eget tincidunt condimentum, eros ipsum rutrum orci, sagittis tempus lacus enim ac dui. <a href="#">Donec non enim</a> in turpis pulvinar facilisis. Ut felis.</p>
				</div>
		  	</div>
		  </div>
